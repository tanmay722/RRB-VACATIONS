...
import { customTourFormSubmissions } from "../../data/forms";
import {
  Eye,
  Mail,
  Phone,
...
export default function CustomTourForms() {
  const [forms, setForms] = useState(customTourFormSubmissions);
    ...
    <div className="p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Manage and respond to custom tour requests
        </p>
      </div>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {filteredForms.map((form) => (
              <tr key={form.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm text-gray-900">{form.budget}</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <span
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{selectedForm.budget}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{selectedForm.travelers}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedForm.interests.map((interest, index) => (
                      <span
                        key={index}
                ...
                <div className="mt-4">
                  ...
                  <p className="font-medium">
                    {selectedForm.accommodationType}
                  </p>
                </div>
              </div>
              ...
              <div className="border-t pt-6">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <button
                    onClick={() =>
                      handleStatusChange(selectedForm.id, "Proposal Sent")
                    }
                    className={`px-4 py-2 rounded-md text-sm font-medium ${
                      selectedForm.status === "Proposal Sent"
